    ...
    extend: {
      ...
      colors: {
        ...
        pos: {
          ...
          "quick-action": "hsl(var(--pos-quick-action))",
          amount: "hsl(var(--pos-amount))",
          offline: "hsl(var(--pos-offline))",
          online: "hsl(var(--pos-online))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        'pos': '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
